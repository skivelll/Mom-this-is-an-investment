...
- Name: moderation.spec.ts >> senior moderator approves a user request and wishlist is relinked to an active catalog variant
- Location: e2e/moderation.spec.ts:13:5
