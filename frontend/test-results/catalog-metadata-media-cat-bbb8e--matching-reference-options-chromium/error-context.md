...
- Name: catalog-metadata-media.spec.ts >> catalog dynamic reference attributes show only matching reference options
- Location: e2e/catalog-metadata-media.spec.ts:9:5
