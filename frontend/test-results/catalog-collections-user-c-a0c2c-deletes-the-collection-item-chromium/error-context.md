...
- Name: catalog-collections.spec.ts >> user creates a collection, adds a catalog variant, edits and deletes the collection item
- Location: e2e/catalog-collections.spec.ts:12:5
